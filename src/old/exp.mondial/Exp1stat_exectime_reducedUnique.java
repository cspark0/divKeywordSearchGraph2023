...
public class Exp1stat_exectime_reducedUnique {

	static List<String> query = new ArrayList<String>();
    static CPUUtil cpuutil = new CPUUtil();

/*
    static List<List<String>> listOfQueries = new ArrayList<List<String>>();
    public static void loadQueries(BufferedReader br) {
        while (true) {
...
//		String[] M = {"blinks", "blinks-NonRed", "nonRed", "nonRednonDup" };
		...
		f2 = new File(Params.ExpDB + "/exp1/" + "reducedUnique" + "-stat-exectime.txt");			
		try {
...
//				pw2.print((end - start)/1000.0 + "  ");	
                pw2.printf("%.6f, ", (end - start)/1000000000.0);
