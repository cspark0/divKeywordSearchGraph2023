...
import queryProcessing.old.Searcher4;
import util.Params;
import util.CPUUtil;

public class Exp1stat_exectime_constDup {
...
//		int k = Integer.parseInt(args[0]);
		...
		DirectedGraph<Integer, DefaultEdge> g = Searcher4.loadGraph();
...
//		String[] M = {"blinks", "blinks-NonRed", "nonRed", "nonRednonDup" };
		...
		f2 = new File(Params.ExpDB + "/exp1/" + "constDup" + "-stat-exectime.txt");			
		try {
