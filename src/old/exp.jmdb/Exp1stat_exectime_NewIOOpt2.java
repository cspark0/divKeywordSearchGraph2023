...
import queryProcessing.old.BlinkSearcherBDB_NewIOOpt2;
import queryProcessing.old.Searcher2;
import util.Params;
import util.CPUUtil;

public class Exp1stat_exectime_NewIOOpt2 {
...
//		BlinkSearcherBDB_ReducedUnique3 searcher = new BlinkSearcherBDB_ReducedUnique3(g);
//		BlinkSearcherBDB_ReducedUnique_mh searcher = new BlinkSearcherBDB_ReducedUnique_mh(g);
		BlinkSearcherBDB_NewIOOpt2 searcher = new BlinkSearcherBDB_NewIOOpt2(g);
...
//		String[] M = {"blinks", "blinks-NonRed", "nonRed", "nonRednonDup" };
		...
		f2 = new File(Params.ExpDB + "/exp1/" + "reducedUnique_IOOpt2" + "-stat-exectime.txt");			
		try {
...
//				searcher.printResult(query, pw1);
	//			searcher1.printStat(pw2, (end - start)/1000.0);
				pw2.print((end - start)/1000000000.0 + "  ");	
