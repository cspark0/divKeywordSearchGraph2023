...
import queryProcessing.old.BlinkSearcherBDB_NewBF2;
import queryProcessing.old.Searcher2;
import util.Params;
import util.CPUUtil;

public class Exp1stat_exectime_NewBF2 {
...
//		searcher[2] = new BlinkSearcherBDB_Reduced(g);
		BlinkSearcherBDB_NewBF2 searcher = new BlinkSearcherBDB_NewBF2(g);
...
//		String[] M = {"blinks", "blinks-NonRed", "nonRed", "nonRednonDup" };
		...
		f2 = new File(Params.ExpDB + "/exp1/" + "reducedUnique_BF" + "-stat-exectime.txt");			
		try {
