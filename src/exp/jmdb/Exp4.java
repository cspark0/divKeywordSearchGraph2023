...
//		double[] tau = {0.2, 0.4, 0.6, 0.8}; //0.5; // Double.parseDouble(args[1]); 
		double[] tau= {0.25}; //0.5; // Double.parseDouble(args[1]); 
		int qsize = 1055; //0.3; // Double.parseDouble(args[1]); 
		...
		//astar12nc = true; 
		//astar1_ap_new = true; 
		astar1nc_ap_new = false;// true; 
		simgrp = true;

		try {
			String filename = "/exp4.t" + tau[0] + ".q" + qsize + ".k" + K[0];
