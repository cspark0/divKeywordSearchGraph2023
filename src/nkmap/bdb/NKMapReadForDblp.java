...
public class NKMapReadForDblp extends NKMapRead {

    protected static String myDbEnvPath2;
    
    // Encapsulates the database environment and databases.
    protected static MyDbEnv myDbEnv2;
...
//        curConfig.setReadUncommitted(true);
    ...
    public void reset() {
    	...
    	myDbEnv2.setup(myDbEnvPath2, // path to the environment home
                true);      		// is this environment read-only?
       	System.out.println("NKMapReadForDblp re-started.");
    }
    ...
    public void close() { 
		super.close();
		myDbEnv2.close(); 
       	System.out.println("NKMapReadForDblp closed.");
	}

    public MyDbEnv getMyDbEnv2() { return this.myDbEnv2; }
    
/*
    public static void main(String args[]) {
		Params.setExpDB("dblp");
//		NKMapRead eir = new NKMapRead("res/dblp/NKMap");
