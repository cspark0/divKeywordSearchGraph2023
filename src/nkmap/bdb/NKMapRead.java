...
public class NKMapRead {
    ...
    protected static String myDbEnvPath1;
    
    // Encapsulates the database environment and databases.
    protected static MyDbEnv myDbEnv1;
...
//        curConfig.setReadUncommitted(true);
    ...
    // protected static CursorConfig curConfig = new CursorConfig();

    protected static TupleBinding<KeywordNode> keyBinding = new KeywordNodeBinding();
    protected static TupleBinding<RelSourceFirst> firstDataBinding = new RelSourceFirstBinding();
    protected static TupleBinding<RelSource> dataBinding = new RelSourceBinding();
...
//        curConfig.setReadUncommitted(true);
	*/
    ...
    public void reset() {
    	...
    	myDbEnv1.setup(myDbEnvPath1, // path to the environment home
                true);      		// is this environment read-only?
       	System.out.println("NKMapRead re-started.");
    }

    public void close() { 
		myDbEnv1.close();
       	System.out.println("NKMapRead closed.");
	}

    public MyDbEnv getMyDbEnv1() { return this.myDbEnv1; }
...
*/
    protected static DatabaseEntry searchKey = new DatabaseEntry();
    protected static DatabaseEntry foundData = new DatabaseEntry();
