...
public class Astar1nc_ap_new extends AstarNcSearcher {
        ...
        public Astar1nc_ap_new() {}

        public Astar1nc_ap_new(DirectedGraph<Integer, DefaultEdge> g) {
                super(g);
        }
...
//                        logger.debug("Popped state s: " + s);
                        ...
                        if (s.ub < ub_unseen) // no optimal answer exists in Tops!  
						{
							//////////////////////////////////////////////
							// Astar1nc feature
						    // if (s.ub > score[Params.K]) score[Params.K] = s.ub;  - comment out at 2022/05/15
							////////////////// 
                        ...
                        if (s.answer.size() == Params.K) {
                        		...
                        		if (s.score >= ub_unseen) {
									...
									//////////////////////////////////////////////
									// Astar1nc feature
									// if (s.score > score[Params.K]) score[Params.K] = s.score;  - comment out at 2022/05/15
									//////////////////////////////////////////////
                        ...
                        for (int i = s.pos + 1; i <= lastIndexOfTops; i++) {
                                ...
                                if (newSumDiss >= 0) { // diss-condition is satisfied!
                                        ...
                                        // Astar1nc feature
                                        //  - added at 2022/05/15
                                        if (e.score > score[e.answer.size()]) score[e.answer.size()] = e.score;
										...
										//////////////////////////////////////////////
											...
											// if (e.ub >= ub_unseen) {   - comment out at 2022/05/15
		                                    	Q.add(e);
												s_was_expanded = true;
												num_of_states_created++;
												num_of_states_in_Q++;
										...
										// _ap feature: higher ub_unseen
											...
											//////////////////////////////////////////////
											// Astar1nc feature
											// if (e.ub > score[n]) score[n] = e.ub;   - comment out at 2022/05/15
											//////////////////////////////////////////////
