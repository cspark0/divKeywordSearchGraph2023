 ...
 */
public class BellmanFordShortestPathMod<V, E>
{
    ...
    private BellmanFordIteratorMod<V, E> iter;
    ...
    public Set<V> getEndVertices() {
    	Map<V, BellmanFordPathElement<V, E>> vData = this.iter.getVertexData();
    	return vData.keySet();
    }
    ...
    public List<E> getPathEdgeListMod(V endVertex)
    {
...
//        lazyCalculate();
     ...
     * @param startVertex
     */
    public BellmanFordShortestPathMod(Graph<V, E> graph, V startVertex)
    {
     ...
     */
    public BellmanFordShortestPathMod(
        Graph<V, E> graph,
        V startVertex,
        int nMaxHops)
    {
    ...
    /* inserted by cspark */
    public void setStartVertex(V sv) { this.startVertex = sv; }
    public void reset() { 
        this.passNumber = 1;
        this.iter = null; 
    }
    ...
    private void assertGetPath(V endVertex)
    {
        ...
        if (!this.graph.containsVertex(endVertex)) {
            throw new IllegalArgumentException(
                "Graph must contain the end vertex!" + endVertex);
        }
    }
    ...
    private void lazyCalculate()
    {
        if (this.iter == null) {
            this.iter =
                new BellmanFordIteratorMod<V, E>(
                    this.graph,
                    this.startVertex,
                    epsilon);
        }
    ...
    public static <V, E> List<E> findPathBetween(
        ...
        V endVertex)
    {
        BellmanFordShortestPathMod<V, E> alg =
            new BellmanFordShortestPathMod<V, E>(
                graph,
                startVertex);
