...
public class Astar1_22 extends AstarSearcher {
        public Astar1_22() {}

        public Astar1_22(DirectedGraph<Integer, DefaultEdge> g) {
                super(g);
        }
...
//                                if (finalRound || s.score >= ub_unseen) {
 ...
 //                               }
						...
						//////////////////////////////////////////////
						// Astar1_22 feature: early stop condition
