...
public class FibonacciHeap<T>
{
     ...
     * value.
     */
    public void decreaseKey(FibonacciHeapNode<T> x, float k)
    {
        if (k > x.key) {
...
//        decreaseKey(x, Double.NEGATIVE_INFINITY);
        decreaseKey(x, Float.NEGATIVE_INFINITY);
     ...
     */
    public void insert(FibonacciHeapNode<T> node, float key)
    {
        node.key = key;
...
/*
    public void removeAllNodesIntoPool(FibonacciHeapNodePool<T> pool) 
    {
        ...
        while (!stack.empty()) {
            ...
            FibonacciHeapNode<T> start = curr;
            curr = curr.right;
            pool.returnFibonacciHeapNode(start);
            ...
            while (curr != start) {
                ...
                temp = curr;
                curr = curr.right;
                pool.returnFibonacciHeapNode(temp);
            }
        }
        minNode = null;
        nNodes = 0;
