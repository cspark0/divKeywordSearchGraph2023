...
public class Exp1stat_exectime_blinks {
...
//		Searcher[] searcher = new Searcher[4];
		BlinkSearcherBDB2 searcher = new BlinkSearcherBDB2(g);
//		searcher[1] = new BlinkSearcherBDB_RedundantExclusion(g);
...
//		String[] M = {"blinks", "blinks-NonRed", "nonRed", "nonRednonDup" };
		...
		f2 = new File(Params.ExpDB + "/rootdup/" + "blinks" + "-stat-exectime.txt" + args[0]);			
		try {
...
//			for (int i = 0; i < K.length; i++) {		
				...
				pw1.println("Blink Search Using BDB " + Params.K);
