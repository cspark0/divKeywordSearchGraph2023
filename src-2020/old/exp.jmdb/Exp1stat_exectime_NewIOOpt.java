...
public class Exp1stat_exectime_NewIOOpt {
...
//		BlinkSearcherBDB_ReducedUnique_mh searcher = new BlinkSearcherBDB_ReducedUnique_mh(g);
		BlinkSearcherBDB_NewIOOpt searcher = new BlinkSearcherBDB_NewIOOpt(g);
...
//		String[] M = {"blinks", "blinks-NonRed", "nonRed", "nonRednonDup" };
		...
		f2 = new File(Params.ExpDB + "/exp1/" + "reducedUnique_NewIOOpt" + "-stat-exectime.txt");			
		try {
...
//				searcher.printResult(query, pw1);
	//			searcher1.printStat(pw2, (end - start)/1000.0);
				...
				pw2.printf("%.3f  ", searcher.accFindUniqTime/1000000000.0);
