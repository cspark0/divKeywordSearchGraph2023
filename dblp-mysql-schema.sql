...
create table paper2author (
 ...
 aid mediumint unsigned
);

create table citation (
 pid mediumint unsigned,
 refpid mediumint unsigned
);


# 0.5. create a lucene index for text attributes of all tuples 
cd (project_home)
mkdir res/dblp/index-dblp
rm res/dblp/index-dblp/(*)

java -cp lib/mysql-connector-java-5.1.19.jar:lib/lusql-3.6.jar ca.gnewton.lusql.core.LuSqlMain -q  "select id, concat(title,' ',abstract) as text from paper" -c "jdbc:mysql://localhost/dblp?user=cspark&password=cspark1234" -l res/dblp/index-dblp -i "id=Index.NO:Store.YES:TermVector.NO"  
java -cp lib/mysql-connector-java-5.1.19.jar:lib/lusql-3.6.jar ca.gnewton.lusql.core.LuSqlMain -q "select id, name as text from author" -c "jdbc:mysql://localhost/dblp?user=cspark&password=cspark1234" -l res/dblp/index-dblp  -A  -i "id=Index.NO:Store.YES:TermVector.NO"  -map "name=text"
java -cp lib/mysql-connector-java-5.1.19.jar:lib/lusql-3.6.jar ca.gnewton.lusql.core.LuSqlMain -q "select id, name as text from venue" -c "jdbc:mysql://localhost/dblp?user=cspark&password=cspark1234" -l res/dblp/index-dblp -A  -i "id=Index.NO:Store.YES:TermVector.NO"  -map "name=text"

# 0.6.  build a table KNS (and its index) from lucene index (compute scores) 
drop table KNS;
ant dblp.loadLuceneIndexToKNS 
(including create index ikns on KNS(keyword);)
## There are 39247258 keywords and 575971 distinct keywords in the graph.

# 5. build KNS_SEL for selected keywords 
drop table KNS_SEL;
create table KNS_SEL
  select * from KNS where keyword in (
			"keyword", "search", "graph", "embedding", "link", "prediction", 
...
## There are 2394998 vertices, 11483615 edges in the graph.

#rm res/dblp/NMR.txt  	# custious !!!
#rm res/dblp/NMR.0.2000000  	# custious !!!
#rm res/dblp/NMR.5000000.6000000  	# custious !!!
#rm res/dblp/NMR.9000000.10000000  	# custious !!!
#...

ant dblp.buildGraph 	
#ant dblp.buildGraph1 	# compute NMR for start node No. 0 ~ 2000000
#ant dblp.buildGraph2 	# compute NMR for start node No.: 5000000 ~ 6000000
#ant dblp.buildGraph3 	# compute NMR for start node No.: 9000000 ~ 10000000
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.0.2000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.5000000.6000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.9000000.10000000' --fields-terminated-by=',' 
...
rm res/dblp/basicIndex/(*)
rm res/dblp/NKMapForBlink/(*)
rm res/dblp/NKMapForBlink/sub/(*)
rm res/dblp/NKMapForBlink2/(*)
rm res/dblp/NKMapForBlink2/sub/(*)

# edit build.xml to change <arg value='KNNR_1' /> for arguments of dblp.buildIndexForKeyword

# edit String[] selectedKeywords in src/index/dblp/buildIndexForKeyword.java to include the keywords defined in the table KNS_SEL

ant dblp.buildIndexForKeyword
/*
ant dblp.buildIndexForKeyword1
ant dblp.buildIndexForKeyword2
ant dblp.buildIndexForKeyword3
ant dblp.buildIndexForKeyword4
ant dblp.buildIndexForKeyword5
ant dblp.buildIndexForKeyword6
*/
...
# edit args(tau and q.size) in build.xml for dblp.Exp1stat 
ant dblp.Exp1stat
...
mysqldump -ucspark -p dblp > dblp.sql 
mysqldump -ucspark -p dblp NMR > dblp.NMR.sql 

mysql -ucspark -p < dblp.sql 
mysql -ucspark -p dblp < dblp.NMR.sql 
...
drop table movies2actors0;
drop table movies2dirs0;
drop table genres0;
...
# result in 68K movies which have actor, director, genre, and 
...
# results in 515K actors 941K mov2act0
####################################################
...
# results in 52K directors and 76K mov2dir0
...
# results in 6279 genres0, 67775 mov2genres0, 40307 keywords0, 49218 mov2keywords0
/*
...
#rm res/dblp/NMR.txt  	# custious !!!
rm res/dblp/NMR.0.1000000  	# custious !!!
rm res/dblp/NMR.1000000.2000000  	# custious !!!
rm res/dblp/NMR.2000000.3000000  	# custious !!!
...

ant dblp.buildGraph1 	# compute NMR for start node No. 0 ~ 1000000
ant dblp.buildGraph2 	# compute NMR for start node No.1000000 <= < 2000000
ant dblp.buildGraph3 	# compute NMR for start node No.: 2000000 ~ 3000000
ant dblp.buildGraph5 	# compute NMR for start node No.: 4000000 ~ 5000000
ant dblp.buildGraph6 	# compute NMR for start node No.: 5000000 ~ 6000000
ant dblp.buildGraph7 	# compute NMR for start node No.: 6000000 ~ 7000000
ant dblp.buildGraph8 	# compute NMR for start node No.: 7000000 ~ 8000000
ant dblp.buildGraph9 	# compute NMR for start node No.: 8000000 ~ 9000000
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.0.1000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234'  -p dblp --local 'res/dblp/NMR.1000000.2000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.2000000.3000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.4000000.5000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.5000000.6000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.6000000.7000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.7000000.8000000' --fields-terminated-by=',' 
mysqlimport --user='' --password='cspark1234' -p dblp --local 'res/dblp/NMR.8000000.9000000' --fields-terminated-by=',' 
create index inmr on NMR(endNode);
...
/*
select a.keyword, b.startNode as destNode, b.endNode as srcNode, b.firstNode, a.score*b.rel AS rel   
  INTO OUTFILE 'res/dblp/knnr_1.txt'
